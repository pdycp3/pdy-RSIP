...
void SARibbonActionsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SARibbonActionsManager *_t = static_cast<SARibbonActionsManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (SARibbonActionsManager::*_t)(int , bool );
...
const QMetaObject SARibbonActionsManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SARibbonActionsManager.data,
      qt_meta_data_SARibbonActionsManager,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SARibbonActionsManagerModel *_t = static_cast<SARibbonActionsManagerModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SARibbonActionsManagerModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_SARibbonActionsManagerModel.data,
      qt_meta_data_SARibbonActionsManagerModel,  qt_static_metacall, nullptr, nullptr}
};
